...
class tinyPhp {
	...
	function get_tiny($snippet, $replace_variables = FALSE, $remove_whitespace = FALSE, $remove_comments = FALSE, $additional_excludes = array()) {
		...
		return htmlentities($new_source, ENT_COMPAT, 'UTF-8');
	}
